		...
		<h:form>
			...
			<h:panelGrid columns="2">
				...
				<h:inputText value="#{clienteBacking.numeroLogradouro}"
					maxlength="50" size="48" onkeyup="masc_numero(this)" />
			</h:panelGrid>
			...
			<h:panelGrid columns="2">
				...
				<h:inputText value="#{clienteBacking.cep}" maxlength="50" size="52"
			...
			<h:panelGrid columns="2">
				...
				<h:inputText value="#{clienteBacking.telefone}" maxlength="50"
					size="47" onkeyup="masc_telefone(this)" />
			</h:panelGrid>

			<h:panelGrid columns="2">
				<h:outputText value="CPF: " />
				<h:inputText value="#{clienteBacking.cpf}" maxlength="50" size="52"
					onkeyup="masc_cpf(this)" readonly="true" />
			</h:panelGrid>

			<h:panelGrid columns="2">
				<h:outputText value="RG: " />
				<h:inputText value="#{clienteBacking.rg}" maxlength="50" size="53"
			...
			<h:panelGrid columns="2">
				...
				<h:inputText value="#{clienteBacking.dataNascimento}" maxlength="50"
					size="34" onkeyup="masc_nascimento(this)" readonly="true" />
			</h:panelGrid>
